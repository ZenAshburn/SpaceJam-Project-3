...
class MyApp(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Dumbledore = spaceJamClasses.Dumbledore(self.loader, "./Assets/Spaceships/Dumbledore/Dumbledore.egg", self.render, "Dumbledore", "./Assets/Spaceships/Dumbledore/spacejet_C.png", (0, 0, 0), 2)
